...
- **Antora page titles:** H1 = `nav.adoc` label; prefer no divergent `:navtitle:`. Section landings: linked parent (link text = H1), not `.Section` + Overview. Detail: `general/documentation.md`.
