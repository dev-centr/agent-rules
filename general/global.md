...
- Read `general/documentation.md` when you are authoring, structuring, or publishing project documentation (optional layer for doc-heavy work). That file’s **Audience role / point of view** gate is required: write for published readers, not the chat commissioner.
