...
. Optional: install Cursor skills from this repo — shop file link:https://github.com/dev-centr/agent-rules/blob/main/skills/BOOTSTRAP.md[`skills/BOOTSTRAP.md`] · Antora xref:bootstrap.adoc[Bootstrap Cursor skills].
