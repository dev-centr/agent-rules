...
:page-audience: Maintainers and adopters choosing or reviewing which skills exist
:page-usage-context: Docs-hub reference / inventory (may be used as a lookup page). Living source of truth remains `skills/CATALOG.md` in the repo
