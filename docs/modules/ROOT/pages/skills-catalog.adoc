...
| `bootstrap-org`
| Bootstrap an org; create a GitHub organization; start a company/nonprofit; populate org data; `.github` profile; github.io; docs hub; SolidStart / solid-ui; named SDL profile; fast-path business bootstrap
|===
