...
== Reference implementation (Hornet)

DevCentr ships a reference runtime at link:https://github.com/dev-centr/hornet[`dev-centr/hornet`] (see xref:agent-harness.adoc[Agent harness (Hornet)]).
...
HCI Nerdz demo remains a static teaching surface; Hornet is the live `$CHAT_ROOT` backend.
