...
:description: Harness copy-on-write speculative edits, single-process LSP multiplexing, tgc vs @nogc — lag-resistant design without Tree-sitter live DOM or duplicate extension hosts.
:page-layout: docs
:page-audience: Engineers designing harness speculative validation
...
That pattern correlates with UI lag. The harness refuses it.
