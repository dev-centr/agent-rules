...
| `demo-site-wiring` | interactive demos, new UI concept / layout / chrome / windowing idea, demos browser/index, demo breadcrumb, VCS logo on demo chrome, lay demo copy, variant tabs, mockup-as-nav, placeholder until chosen, multi-variant desk, intro anchoring screenshot/mockup, org-site demo catalog, Edge Bar, context edges | active | Auto on UI invent/ship (owned orgs); single hero **or** one compact mockup per variant; grandfather old demos; no push/PR suppress |
