...
| `demo-site-wiring` | interactive demos, new UI concept / layout / chrome / windowing idea, demos browser/index, demo breadcrumb, VCS logo on demo chrome, lay demo copy, org-site demo catalog | active | Auto on UI invent/ship (owned orgs); grandfather old demos; no push/PR suppress |
