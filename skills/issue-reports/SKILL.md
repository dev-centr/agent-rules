...
name: issue-reports
description: >-
  Use when writing, drafting, or filing an issue report, bug report, or
  feature request; gh issue create; ISSUES_REPO; .issues submissions;
  do not leave the issue only in chat.
---
