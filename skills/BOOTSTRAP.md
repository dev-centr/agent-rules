...
- **Update consumers / recursive fan-out (any lib)** → skill `update-consumers` (`skills/update-consumers/`).
- **Antora extension topics / pins** → skill `antora-extension-consumers` (`skills/antora-extension-consumers/`; specialization of `update-consumers`).
