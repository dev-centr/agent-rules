...
- Name the topic, claim, or job before any scene or example.
- If removing the body would leave the title opaque, rewrite the title (or lead with the claim and keep the scene in the body).
- Prefer: `Making model assumptions transparent`
...
Philosophy (optional depth): [Titles as orientation](https://hci-nerdz.github.io/blog/titles-as-orientation/).
